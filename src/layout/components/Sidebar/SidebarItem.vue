<template>
  <div v-if="!item.hidden">
    <!--没有子节点 或 只有一个子节点且不想将父节点渲染出来的情况-->
    <template v-if="(item.path === '/' || !item.children) && hasOneShowingChild(item.children,item) && (!onlyOneChild.children||onlyOneChild.noShowingChildren)&&!item.alwaysShow">
