...
export const constantRoutes = [
  ...
  //   component: Layout,
  //   name: 'user_center',
  //   meta: { title: '用户中心', icon: 'PersonnelControl' },
  //   children: [
  //     {
  //       path: 'organization',
  //       name: 'organization',
  ...
  //       path: 'role',
  //       name: 'role',
  //       component: resolve => require(['@/views/roleManage/index'], resolve),
  //       meta: { title: '角色管理' }
  //     },
  //     {
  //       path: 'user',
  ...
  //       path: 'post',
  //       name: 'post',
  //       component: resolve => require(['@/views/postManagement/index'], resolve),
  //       meta: { title: '岗位管理' }
  //     }
  //   ]
  // },
